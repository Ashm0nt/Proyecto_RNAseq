...
# Transformar sujeto a factor
subject <- factor(rse_muscle_filtered$sra_attribute.subject_id)

#Grupo de tratamiento
group <- rse_muscle_filtered$sra_attribute.drug

# Cargar los datos a un formato DGE
dge <- DGEList(counts = counts_muscle_filtered)

# Diseño de estudio
desing <- model.matrix(~ subject + group)
