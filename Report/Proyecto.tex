...
\begin{titlepage}
    ...
    {\Large 22 de febrero de 2026\par}
...
(Ameya S. Kulkarni, Gubbi, y Barzilai 2020; Ameya S. Kulkarni et~al.
2018; Dutta et~al. 2023). Estudios epidemiológicos han sugerido un
posible efecto geroprotector de la metformina, asociado con la reducción
en la incidencia de enfermedades relacionadas con la edad, como las
enfermedades cardiovasculares, distintos tipos de cáncer y padecimientos
neurodegenerativos, así como con una disminución de la mortalidad
independiente de sus efectos sobre el metabolismo de la glucosa (Ameya
S. Kulkarni, Gubbi, y Barzilai 2020; Ameya S. Kulkarni et~al. 2018;
Dutta et~al. 2023).
...
durante el envejecimiento (Ameya S. Kulkarni et~al. 2018).

El conjunto de datos analizados en este proyecto se deriva del estudio
de Kulkarni et al. (Ameya S. Kulkarni et~al. 2018) generados a partir de
...
\pandocbounded{\includegraphics[keepaspectratio]{Proyecto_files/figure-latex/sequencing_depth-1.pdf}}
...
\begin{center}\includegraphics[width=0.9\linewidth]{Proyecto_files/figure-latex/lectures_genes-1} \end{center}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Plot de lecturas asignadas a genes por tratamiento}
\FunctionTok{ggplot}\NormalTok{(}
\NormalTok{  df\_qc,}
  \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ drug, }\AttributeTok{y =}\NormalTok{ assigned\_gene\_prop, }\AttributeTok{fill =}\NormalTok{ drug)}
\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_boxplot}\NormalTok{(}\AttributeTok{outlier.shape =} \ConstantTok{NA}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_jitter}\NormalTok{(}\AttributeTok{width =} \FloatTok{0.15}\NormalTok{, }\AttributeTok{alpha =} \FloatTok{0.7}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}
    \AttributeTok{title =} \StringTok{"Lecturas asignadas a genes por tratamiento"}\NormalTok{,}
    \AttributeTok{x =} \StringTok{"Tratamiento"}\NormalTok{,}
    \AttributeTok{y =} \StringTok{"Número de lecturas asingadas a genes"}
\NormalTok{  ) }\SpecialCharTok{+}
  \FunctionTok{theme\_minimal}\NormalTok{(}\AttributeTok{base\_size =} \DecValTok{15}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{theme}\NormalTok{(}
...
\begin{center}\includegraphics[width=0.9\linewidth]{Proyecto_files/figure-latex/lectures_genes-2} \end{center}
...
\pandocbounded{\includegraphics[keepaspectratio]{Proyecto_files/figure-latex/MDS-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Proyecto_files/figure-latex/variance_partition-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Proyecto_files/figure-latex/differential_expression-1.pdf}}
...
\includegraphics[width=\linewidth]{Proyecto_files/figure-latex/MA_plot-1}
...
\begin{center}\includegraphics[width=\linewidth]{Proyecto_files/figure-latex/Volcano_plot-1} \end{center}
...
\subsubsection{HEATMAP de genes
seleccionados}\label{heatmap-de-genes-seleccionados}
...
\begin{center}\includegraphics[width=\linewidth]{Proyecto_files/figure-latex/heatmap-1} \end{center}
...
\subsubsection{Análisis de varianza para los genes más
...
\begin{center}\includegraphics[width=0.9\linewidth]{Proyecto_files/figure-latex/variance_top_genes_up-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{Proyecto_files/figure-latex/variance_top_genes_up-2} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{Proyecto_files/figure-latex/variance_top_genes_down-1} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{Proyecto_files/figure-latex/variance_top_genes_down-2} \end{center}
...
\pandocbounded{\includegraphics[keepaspectratio]{Proyecto_files/figure-latex/MDS_top_genes-1.pdf}}
...
\subsection{GENES UPREGULATED}\label{genes-upregulated}
...
\subsection{GENES DOWNREGULATED}\label{genes-downregulated}
...
\bibitem[\citeproctext]{ref-dutta-2023}
Dutta, Siddhartha, Rima B Shah, Shubha Singhal, Sudeshna Banerjee Dutta,
Sumit Bansal, Susmita Sinha, y Mainul Haque. 2023. {«{Metformin: A
Review of Potential Mechanism and Therapeutic Utility Beyond
Diabetes}»}. \emph{Drug Design Development and Therapy} Volume 17
(junio): 1907-32. \url{https://doi.org/10.2147/dddt.s409373}.

\bibitem[\citeproctext]{ref-kulkarni-2018}
Kulkarni, Ameya S, Erika F Brutsaert, Valentin Anghel, Kehao Zhang, Noah
Bloomgarden, Michael Pollak, Jessica C Mar, Meredith Hawkins, Jill P
Crandall, y Nir Barzilai. 2018. {«{Metformin regulates metabolic and
nonmetabolic pathways in skeletal muscle and subcutaneous adipose
tissues of older adults}»}. \emph{Aging Cell} 17 (2).
\url{https://doi.org/10.1111/acel.12723}.

\bibitem[\citeproctext]{ref-kulkarni-2020}
Kulkarni, Ameya S., Sriram Gubbi, y Nir Barzilai. 2020. {«{Benefits of
Metformin in Attenuating the Hallmarks of Aging}»}. \emph{Cell
Metabolism} 32 (1): 15-30.
